        ...
        <div className="pg-t-1 pg-l-0-5 pg-r-0-5 w-80 mg-auto field">
            ...
            <div className="no-over-flow" style={{ height: `${height}px` }}>
                <div className="pg-l-5 drop-container outer-drop-container">
                    <div className="flex flex-end mg-t-1">
                        <div className="flex pg-t-0-5 pg-l-0-5 pg-b-0-5 pg-r-0-5 border-radius-0-5 button-theme border-pale" onClick={ saveState }>
                            <div className="flex flex-middle">
                                <span className="block">Save</span>
                            </div>
                            <div className="flex flex-middle">
                                <img className="drop-icon mg-l-1" src = "/icon/save.png" />
                            </div>
                        </div>
                    </div>
                                ...
                                { innerDrop ?
                                 ...
                                 <div className="absolute r-0 t-100 no-over-flow index-2" style={{ height: `${innerHeight}px` }}>
                                    ...
                                    { dataTypes.map( (type, index) =>
                                        <div key={index} className="pg-t-0-5 pg-l-1 pg-b-0-5 drop-item hover border-bottom-pale flex flex-no-wrap bg-white" onClick={ ()=> { setDataType(type) } }>
                    ...
                    <div className="mg-t-2">
                        ...
                        <div className="flex flex-no-wrap w-fit mg-t-2">
                            <div className="w-50 flex flex-middle">
                                ...
                                <div className="absolute r-0 b-100 no-over-flow bg-white shadow" style={{ height: `${foreignKeyDropRelationHeight}px` }}>
                                   <div className="drop-container h-200 w-fit scroll-y" >
                                        { relations.map( (rel, index) =>
                                            <div key={rel.id} className="pg-t-0-5 pg-l-1 pg-b-0-5 drop-item hover border-bottom-pale flex flex-no-wrap bg-white" onClick={ ()=> { setForeignKeyRelation(rel); setField({ ...field, foreign_key: { rel: rel.name } }) } }>
